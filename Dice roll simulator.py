...
while roll_dice == "yes":
    if roll_dice == "yes":
        dice_type = int(input("These are the dice you have available: {} which type of dice would you like to roll?".format(dice)))
        if dice_type == 2 or 3 or 4 or 5 or 6 or 8 or 10 or 12 or 20 or 100:
            ...
            roll_dice = input("Would you like to roll a different dice?").strip().lower()
        roll_dice = input("Would you like to roll again?").strip().lower()
    else:
        print("Okay, Goodbye")
